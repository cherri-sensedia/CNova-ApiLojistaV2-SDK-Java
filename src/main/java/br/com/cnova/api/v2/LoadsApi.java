...
import br.com.cnova.api.v2.model.GetOrdersTrackingResponse;
import br.com.cnova.api.v2.model.LoadsOrdersTrackings;
import java.util.*;
import br.com.cnova.api.v2.model.GetProductsResponse;
import br.com.cnova.api.v2.model.Product;
import br.com.cnova.api.v2.model.GetProductWithErrorsResponse;
import br.com.cnova.api.v2.model.LoadErrors;
import br.com.cnova.api.v2.model.GetSellerItemsPricesResponse;
import br.com.cnova.api.v2.model.LoadsSellerItemsPrices;
import br.com.cnova.api.v2.model.GetSellerItemsStatusResponse;
import br.com.cnova.api.v2.model.LoadsSellerItemsStatus;
import br.com.cnova.api.v2.model.GetSellerItemsStocksResponse;
...
public class LoadsApi {
   ...
   * @return GetOrdersTrackingResponse
   */
  public GetOrdersTrackingResponse getOrdersTrackingDelivered (String createdAt, String status, Integer offset, Integer limit) throws ApiException {
    ...
    try {
      ...
      if(response != null){
        return (GetOrdersTrackingResponse) apiClient.deserialize(response, "", GetOrdersTrackingResponse.class);
      }
      else {
        return null;
      }
   ...
   * @return String
   */
  public String postOrdersTrackingDelivered (List<LoadsOrdersTrackings> ordersTrackings) throws ApiException {
   ...
   * @return GetOrdersTrackingResponse
   */
  public GetOrdersTrackingResponse getOrdersTrackingSent (String createdAt, String status, Integer offset, Integer limit) throws ApiException {
    Object postBody = null;
   ...
   * Operação utilizada para atualização de tracking massivo
   * &lt;p&gt;Operação utilizada para atualização de tracking massivo. &lt;/p&gt;&lt;br/&gt;&lt;p class=&#39;obs obs-danger&#39;&gt; Devido ao formato JSON, é necessário alterar o &lt;strong&gt;HTTP Header: content-type&lt;/strong&gt; para &lt;strong&gt;application/json&lt;/strong&gt; para o correto funcionamento. &lt;p class=&#39;obs&#39;&gt;&lt;strong&gt;Retorno do Serviço&lt;/strong&gt;&lt;br /&gt;O retorno deste serviço é baseado no padrão definido para métodos POST segundo o Status HTTP 201 - Created.&lt;/p&gt;
   * @param ordersTracking Arquivo em formato &lt;strong&gt;JSON&lt;/strong&gt; cujo conteúdo contêm uma lista de objetos de order tracking.
   * @return String
   */
  public String postOrdersTrackingSent (List<LoadsOrdersTrackings> ordersTracking) throws ApiException {
    Object postBody = ordersTracking;
    
    // verify the required parameter 'ordersTracking' is set
    if (ordersTracking == null) {
       throw new ApiException(400, "Missing the required parameter 'ordersTracking' when calling postOrdersTrackingSent");
    }
   ...
   * &lt;p class=&#39;obs obs-danger&#39;&gt;Essa operação só existe para SANDBOX.&lt;/p&gt;&lt;p&gt;Operação utilizada para cancelar itens de uma carga. Os itens só podem ser cancelados se estiverem com erros de importação ou se os produtos estiverem pendentes (status=PENDING).&lt;/p&gt;&lt;p class=&#39;obs&#39;&gt;&lt;strong&gt;Retorno do Serviço&lt;/strong&gt;&lt;br/&gt;O retorno deste serviço é baseado no padrão definido para métodos PUT e DELETE, sendo retornado apenas o Status HTTP 204 - No Content.&lt;/strong&gt;&lt;/p&gt;
   * @param skuSellerId SKU do produto do lojista que deverá ser alterado.
   * @return LoadErrors
   */
  public LoadErrors deleteProduct (String skuSellerId) throws ApiException {
    Object postBody = null;
    ...
    try {
      ...
      if(response != null){
        return (LoadErrors) apiClient.deserialize(response, "", LoadErrors.class);
      }
      else {
        return null;
      }
   ...
   * @param offset Parâmetro utilizado para indicar a posição do registro inicial que será trazido. A primeira posição é sempre zero (0).
   * @param limit Parâmetro utilizado para indicar a quantidade de registros que deve ser trazido na consulta.
   * @return GetSellerItemsPricesResponse
   */
  public GetSellerItemsPricesResponse getSellerItemsPrices (Integer offset, Integer limit) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'offset' is set
    if (offset == null) {
       throw new ApiException(400, "Missing the required parameter 'offset' when calling getSellerItemsPrices");
    }
    
    // verify the required parameter 'limit' is set
    if (limit == null) {
       throw new ApiException(400, "Missing the required parameter 'limit' when calling getSellerItemsPrices");
    }
    ...
    try {
      ...
      String response = apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames);
      if(response != null){
        return (GetSellerItemsPricesResponse) apiClient.deserialize(response, "", GetSellerItemsPricesResponse.class);
      }
      else {
        return null;
      }
   ...
   * &lt;p&gt;Operação utilizada para atualização de preço, de forma massiva, de produtos enviados na carga.&lt;/p&gt;&lt;p class=&#39;obs obs-danger&#39;&gt;O produto só pode ser alterado antes de assumir o status Disponível (AVAILABLE).&lt;br/&gt;Produtos já disponíveis não podem ser alterados através de serviços. Para mais informações, leia a documentação &lt;a href=&#39;#!/loads/loadProducts_post_0&#39; target=&#39;_blank&#39;&gt;&lt;strong&gt;POST /loads/products&lt;/strong&gt;&lt;/a&gt;.&lt;/p&gt;&lt;p class=&#39;obs&#39;&gt;&lt;strong&gt;Retorno do Serviço&lt;/strong&gt;&lt;br/&gt;O retorno deste serviço é baseado no padrão definido para métodos PUT e DELETE, sendo retornado apenas o Status HTTP 204 - No Content.&lt;/strong&gt;&lt;/p&gt;
   * @param body Parâmetros para ativação/desativação massiva de produtos
   * @return String
   */
  public String putSellerItemsPrices (List<LoadsSellerItemsPrices> body) throws ApiException {
    Object postBody = body;
   ...
   * @param offset Parâmetro utilizado para indicar a posição do registro inicial que será trazido. A primeira posição é sempre zero (0).
   * @param limit Parâmetro utilizado para indicar a quantidade de registros que deve ser trazido na consulta.
   * @return GetSellerItemsStatusResponse
   */
  public GetSellerItemsStatusResponse getSellerItemsStatus (Integer offset, Integer limit) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'offset' is set
    if (offset == null) {
       throw new ApiException(400, "Missing the required parameter 'offset' when calling getSellerItemsStatus");
    }
    
    // verify the required parameter 'limit' is set
    if (limit == null) {
       throw new ApiException(400, "Missing the required parameter 'limit' when calling getSellerItemsStatus");
    }
    ...
    try {
      ...
      String response = apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames);
      if(response != null){
        return (GetSellerItemsStatusResponse) apiClient.deserialize(response, "", GetSellerItemsStatusResponse.class);
      }
      else {
        return null;
      }
   ...
   * &lt;p&gt;Operação utilizada para ativação/desativação massiva de produtos enviados na carga.&lt;/p&gt;&lt;p class=&#39;obs obs-danger&#39;&gt;O produto só pode ser alterado antes de assumir o status Disponível (AVAILABLE).&lt;br/&gt;Produtos já disponíveis não podem ser alterados através de serviços. Para mais informações, leia a documentação &lt;a href=&#39;#!/loads/loadProducts_post_0&#39; target=&#39;_blank&#39;&gt;&lt;strong&gt;POST /loads/products&lt;/strong&gt;&lt;/a&gt;.&lt;/p&gt;&lt;p class=&#39;obs&#39;&gt;&lt;strong&gt;Retorno do Serviço&lt;/strong&gt;&lt;br/&gt;O retorno deste serviço é baseado no padrão definido para métodos PUT e DELETE, sendo retornado apenas o Status HTTP 204 - No Content.&lt;/strong&gt;&lt;/p&gt;
   * @param body Parâmetros para ativação/desativação massiva de produtos
   * @return String
   */
  public String putSellerItemsStatus (List<LoadsSellerItemsStatus> body) throws ApiException {
    Object postBody = body;
   ...
   * @param offset Parâmetro utilizado para indicar a posição do registro inicial que será trazido. A primeira posição é sempre zero (0).
   * @param limit Parâmetro utilizado para indicar a quantidade de registros que deve ser trazido na consulta.
   * @return GetSellerItemsStocksResponse
   */
  public GetSellerItemsStocksResponse getSellerItemsStocks (Integer offset, Integer limit) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'offset' is set
    if (offset == null) {
       throw new ApiException(400, "Missing the required parameter 'offset' when calling getSellerItemsStocks");
    }
    
    // verify the required parameter 'limit' is set
    if (limit == null) {
       throw new ApiException(400, "Missing the required parameter 'limit' when calling getSellerItemsStocks");
    }
    ...
    try {
      ...
      String response = apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames);
      if(response != null){
        return (GetSellerItemsStocksResponse) apiClient.deserialize(response, "", GetSellerItemsStocksResponse.class);
      }
      else {
        return null;
      }
   ...
   * &lt;p&gt;Operação utilizada para atualização de estoque, de forma massiva, de produtos enviados na carga.&lt;/p&gt;&lt;p class=&#39;obs obs-danger&#39;&gt;O produto só pode ser alterado antes de assumir o status Disponível (AVAILABLE).&lt;br/&gt;Produtos já disponíveis não podem ser alterados através de serviços. Para mais informações, leia a documentação &lt;a href=&#39;#!/loads/loadProducts_post_0&#39; target=&#39;_blank&#39;&gt;&lt;strong&gt;POST /loads/products&lt;/strong&gt;&lt;/a&gt;.&lt;/p&gt;&lt;p class=&#39;obs&#39;&gt;&lt;strong&gt;Retorno do Serviço&lt;/strong&gt;&lt;br/&gt;O retorno deste serviço é baseado no padrão definido para métodos PUT e DELETE, sendo retornado apenas o Status HTTP 204 - No Content.&lt;/strong&gt;&lt;/p&gt;
   * @param body Parâmetros para atualização massiva de estoque de produtos.
   * @return String
   */
  public String putSellerItemsStocks (List<SellerItemsStocks> body) throws ApiException {
    Object postBody = body;
