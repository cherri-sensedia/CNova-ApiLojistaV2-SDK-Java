...
import br.com.cnova.api.v2.model.GetOrdersResponse;
import br.com.cnova.api.v2.model.OrderSandbox;
import br.com.cnova.api.v2.model.Order;
import br.com.cnova.api.v2.model.OrderItem;
import br.com.cnova.api.v2.model.TrackingUpdate;
...
public class OrdersApi {
  ...
  /**
   * Operação para realizar a aprovação de um pedido
   * &lt;p&gt;Operação para realizar a aprovação de um pedido.&lt;/p&gt;&lt;p class=&#39;obs&#39;&gt;&lt;strong&gt;Retorno do Serviço&lt;/strong&gt;&lt;br/&gt;O retorno deste serviço é baseado no padrão definido para métodos PUT e DELETE, sendo retornado apenas o Status HTTP 204 - No Content.&lt;/strong&gt;&lt;/p&gt;
   * @param skuSellerId SKU do produto do lojista que deverá ser alterado.
   * @return String
   */
  public String putSellerItemsStatusApproved (String skuSellerId) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'skuSellerId' is set
    if (skuSellerId == null) {
       throw new ApiException(400, "Missing the required parameter 'skuSellerId' when calling putSellerItemsStatusApproved");
    }
    

    // create path and map variables
    String path = "/orders/status/approved/{skuSellerId}".replaceAll("\\{format\\}","json")
   ...
   * @return GetOrdersResponse
   */
  public GetOrdersResponse getOrdersByStatusNew (String purchasedAt, String customerName, String customerDocumentNumber, Integer offset, Integer limit) throws ApiException {
    Object postBody = null;
   ...
   * @return OrderItem
   */
  public OrderItem getOrderByIdAndOrderItemId (String orderId, String skuSellerId) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'orderId' is set
    if (orderId == null) {
       throw new ApiException(400, "Missing the required parameter 'orderId' when calling getOrderByIdAndOrderItemId");
    }
    
    // verify the required parameter 'skuSellerId' is set
    if (skuSellerId == null) {
       throw new ApiException(400, "Missing the required parameter 'skuSellerId' when calling getOrderByIdAndOrderItemId");
    }
   ...
   * @return String
   */
  public String postOrderTrackingCancelation (TrackingUpdate body, String orderId) throws ApiException {
   ...
   * @return String
   */
  public String postOrderTrackingDelivered (TrackingUpdate body, String orderId) throws ApiException {
    Object postBody = body;
   ...
   * @return String
   */
  public String postOrderTrackingExchange (TrackingUpdate body, String orderId) throws ApiException {
    Object postBody = body;
   ...
   * @return String
   */
  public String postOrderTrackingReturn (TrackingUpdate body, String orderId) throws ApiException {
    Object postBody = body;
   ...
   * @return String
   */
  public String postOrderTrackingSent (TrackingUpdate body, String orderId) throws ApiException {
    Object postBody = body;
