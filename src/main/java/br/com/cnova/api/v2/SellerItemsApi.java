...
import br.com.cnova.api.v2.model.GetSellerItemsResponse;
import br.com.cnova.api.v2.model.SellerItem;
import br.com.cnova.api.v2.model.SellerItemPrice;
import br.com.cnova.api.v2.model.SellerItemStatus;
import br.com.cnova.api.v2.model.StockUpdate;
...
public class SellerItemsApi {
   ...
   * @return SellerItem
   */
  public SellerItem getDetailsSellerItemOrigin (String skuSellerId, String site) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'skuSellerId' is set
    if (skuSellerId == null) {
       throw new ApiException(400, "Missing the required parameter 'skuSellerId' when calling getDetailsSellerItemOrigin");
    }
   ...
   * @return String
   */
  public String putSellerItemPrices (String skuSellerId, SellerItemPrice body) throws ApiException {
   ...
   * @return String
   */
  public String putSellerItemStock (String skuSellerId, StockUpdate body) throws ApiException {
    Object postBody = body;
