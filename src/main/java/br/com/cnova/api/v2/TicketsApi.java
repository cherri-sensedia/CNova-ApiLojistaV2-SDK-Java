...
import br.com.cnova.api.v2.model.Tickets;
import br.com.cnova.api.v2.model.PostTicket;
import br.com.cnova.api.v2.model.PutAssignee;
import br.com.cnova.api.v2.model.GetTicketMessagesResponse;
import br.com.cnova.api.v2.model.PostTicketMessage;
import br.com.cnova.api.v2.model.PutTicketStatus;
...
public class TicketsApi {
   ...
   * @param status Utilizado para filtrar os tickets com um status específico. Aberto (opened), Aguardando Reembolso (waiting_refund), Atrasado (delayed), Crítico (critical), Em Monitoramente (attendance), Fechado (closed), Todos (all).
   ...
   * @return String
   */
  public String postTicket (PostTicket newTicket) throws ApiException {
   ...
   * @return String
   */
  public String putTicketAssignee (String code, PutAssignee body) throws ApiException {
   ...
   * @return String
   */
  public String postTicketMessage (String code, PostTicketMessage ticket) throws ApiException {
   ...
   * @return String
   */
  public String putTicketStatus (String code, PutTicketStatus body) throws ApiException {
    Object postBody = body;
